...
const EmailForm: FunctionComponent<{
    ...
    return (
        <div className="flex flex-col items-center jusify-center w-full p-2 space-y-3">
            <h3>You can also send the file through email</h3>
            <form className="flex flex-col items-center jusify-center w-full p-2 space-y-3" onSubmit={handleEmail}>
