...
const index: NextPage<{ file: IFile }> = ({ file: { format, name, sizeInBytes, id }}) => {
    ...
    return <div className="flex flex-col items-center justify-center py-3 space-y-3 bg-gray-800 rounded-md shadow-xl w-96">
        {!id ? <span>Oops! File does not exist! Check the URL.</span> : <>
                <img src="/images/file-download.png" alt="" className="w-16 h-15" />
